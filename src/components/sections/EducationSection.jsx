  ...
  const educationData = [
    {
      ...
      description:
        "Currently pursuing a Diploma in Engineering with a focus on Computer Science & Technology. Building a strong foundation in core engineering principles, programming fundamentals, and technical problem-solving.",
    ...
    },
    {
      ...
      description:
        "Completed secondary education with outstanding academic performance, building a strong foundation in science and mathematics.",
    ...
    },
    {
      ...
      description:
        "Intensive full-stack web development course focusing on professional software engineering. Building production-grade projects including SkillSphere, KeenKeeper, and Wanderlust using MongoDB, Express, React, and Node.js.",
      tags: [
        "MongoDB",
        "Express.js",
        "React",
    ...
    <Container id="education" className="relative pb-24 pt-16">
      ...
      >
        ...
        <p className="font-body-md text-on-surface-variant max-w-2xl text-sm md:text-base">
          From SSC to Diploma to full-stack engineering — a timeline of
          continuous growth.
        </p>
        ...
        <div className="flex items-center justify-center gap-8 md:gap-16 mt-12">
          <div className="flex flex-col items-center">
            ...
            <span className="text-[10px] md:text-xs text-on-surface-variant tracking-[0.2em] uppercase font-code-label">
              SSC GPA
            </span>
          </div>
          <div className="flex flex-col items-center">
            <span className="text-2xl md:text-3xl font-bold text-[#007ACC] mb-2">
              3rd
            </span>
            <span className="text-[10px] md:text-xs text-on-surface-variant tracking-[0.2em] uppercase font-code-label">
              DIPLOMA SEM
          ...
          {educationData.map((item, index) => (
            ...
            >
              <div className="hidden sm:flex flex-col items-center relative z-20 shrink-0 w-[64px] md:w-[80px]">
                <div
                  className={`w-16 h-16 rounded-full bg-[#0a0a0a] border-[3px] ${item.borderColor} flex items-center justify-center relative z-20 ${item.glowColor} transition-transform duration-500 hover:scale-110`}
                >
              ...
              <div className="glass-card rounded-[24px] p-6 md:p-8 flex-1 border border-white/5 bg-[#121214]/60 backdrop-blur-xl relative overflow-hidden group hover:border-white/20 transition-all duration-500 hover:shadow-[0_10px_40px_rgba(138,43,226,0.05)]">
                ...
                <div className="flex flex-wrap items-center gap-3 mb-6 relative z-10">
                  <span
                    className={`px-4 py-1.5 rounded-full text-[10px] md:text-xs font-code-label tracking-widest uppercase border ${
                      item.id === "01"
                ...
                <div className="relative z-10 mb-8">
                  <h3 className="font-h3 text-xl md:text-2xl text-white mb-2">
                    {item.title}
                  </h3>
                  ...
                  {item.extraBadge && (
                    <div
                      className={`inline-flex items-center gap-2 px-4 py-2 rounded-xl border bg-white/5 text-xs md:text-sm font-bold mb-6 ${
                        item.id === "02"
                          ? "border-[#007ACC]/20 text-[#007ACC]"
                          : "border-[#47A248]/20 text-[#47A248]"
                      }`}
                    >
                ...
                <div className="flex flex-wrap gap-2 relative z-10 mt-auto">
                  {item.tags.map((tag) => (
                    <span
                      key={tag}
                      className="px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-white/70 text-[10px] font-code-label tracking-widest uppercase hover:text-white hover:bg-white/10 transition-colors"
                    >
                      {tag}
                    </span>
                  ))}
