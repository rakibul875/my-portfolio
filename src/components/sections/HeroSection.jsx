  ...
  return (
    <section id="overview" className="px-6 md:px-8 pt-24 md:pt-32 pb-16 md:pb-24 flex items-center relative overflow-hidden max-w-7xl mx-auto min-h-[80vh]">
      ...
      <div className="z-10 w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
        ...
        >
          <motion.span variants={itemVariants} className="font-code-label text-primary tracking-[0.3em] uppercase mb-4 md:mb-6 block text-xs md:text-sm">
            [ INITIALIZING_SESSION ]
          </motion.span>
          <motion.h1 variants={itemVariants} className="font-h1 text-4xl md:text-5xl lg:text-6xl text-white mb-6 leading-tight">
          ...
          <motion.p variants={itemVariants} className="font-body-lg text-on-surface-variant max-w-xl mb-8 md:mb-10 text-sm md:text-base lg:text-lg">
